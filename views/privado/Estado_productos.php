...
PaginaPrivado::headerPrivado('Estados de productos','EstadoProductos');
?>
    ...
    <div class="row">
        ...
        <div class="col l10 offset-l1 m10 offset-m1 s12">
            <div class="card-panel z-depth-5 center-align" id="CajaEncabezado">
                <div class="row">
                    <h3>Gestión de estados de productos</h3>
                        <div class="row">
    ...
    <div class="row">
        <div class="col l10 offset-l1 m10 offset-m1 s12">
            <div class="card-panel z-depth-5 center-align" id="CajaCuerpo">
                <div class="row">
                    <form method="post" id="Buscar_estado_productos" name="Buscar_estado_productos" autocomplete="off" method="POST" enctype="multipart/form-data" onsubmit="return Validar_Buscar_Estado_Productos();">
                        <div class="input-field center-align col s10 m8 offset-m2 l7 offset-l2">
                            ...
                            <label for="txt_buscar" id="lbBuscar">Buscar estado de producto</label>
                        </div>
...
<div id="save-modal" name="save-modal" class="modal">
    <div class="modal-content">
                <h4 id="modal-title" class="center-align"></h4>
        <form method="post" id="Estado_productos" name="Estado_productos" autocomplete="off" enctype="multipart/form-data" onsubmit="return Validar_Estado_Productos();">
...
<?php
require_once('../../core/helpers/privado.php');
PaginaPrivado::footerPrivado('EstadoProductos');
?>