    ...
    <div class="row">
        ...
        <div class="col l10 offset-l1 m10 offset-m1 s12">
            <div class="card-panel z-depth-5 center-align" id="CajaEncabezado">
                <div class="row">
                    <h3>Gestión de estados de usuarios</h3>
                        <div class="row">
                            <div class="col l8 offset-l2 m12 s12">
                             <!-- Botón para abrir ventana de nuevo registro -->
                                ...
                                <!-- <a onclick="" class="btn-medium waves-effect waves-light cyan btn" href="../../core/reports/privado/EstadoUsuario.php" target="_blank">
    ...
    <div class="row">
        <div class="col l10 offset-l1 m10 offset-m1 s12">
            <div class="card-panel z-depth-5 center-align" id="CajaCuerpo">
                <div class="row">
                    <form method="POST" id="Buscar_estado_usuarios" name="Buscar_estado_usuarios" autocomplete="off" method="POST" enctype="multipart/form-data" onsubmit="return Validar_Buscar_Estado_Usuarios();">
                        <div class="input-field center-align col s10 m8 offset-m2 l7 offset-l2">
                            ...
                            <label for="txt_buscar" id="lbBuscar">Buscar estado de usuario</label>
                        </div>
...
<div id="save-modal" class="modal">
    <div class="modal-content">
        ...
        <form method="POST" id="Estado_usuarios" name="Estado_usuarios" autocomplete="off" method="POST" enctype="multipart/form-data" onsubmit="return Validar_Estado_Usuarios();">
...
<?php
require_once('../../core/helpers/privado.php');
PaginaPrivado::footerPrivado('EstadoUsuarios');
?>