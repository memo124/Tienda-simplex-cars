...
PaginaPrivado::headerPrivado('Estados de clientes','EstadoClientes');
?>
    ...
    <div class="row">
        ...
        <div class="col l10 offset-l1 m10 offset-m1 s12">
            <div class="card-panel z-depth-5 center-align" id="CajaEncabezado">
                <div class="row">
                    <h3>Gestión de estados de clientes</h3>
                        <div class="row">
                            <div class="col l8 offset-l2 m12 s12">
                             <!-- Botón para abrir ventana de nuevo registro -->
                                <a onclick="openCreateModal();" class="btn-medium waves-effect waves-light red btn">Agregar estado<i class="material-icons left">add</i></a>
                                <!-- <a onclick="" class="btn-medium waves-effect waves-light cyan btn" href="../../core/reports/privado/EstadoClientes.php" target="_blank">
    ...
    <div class="row">
        <div class="col l10 offset-l1 m10 offset-m1 s12">
            <div class="card-panel z-depth-5 center-align" id="CajaCuerpo">
                <div class="row">
                    <form method="POST" id="Buscar_estado_clientes" name="Buscar_estado_clientes" autocomplete="off" enctype="multipart/form-data" onsubmit="return Validar_Buscar_Estado_Clientes();">
                        <div class="input-field center-align col s10 m8 offset-m2 l7 offset-l2">
                            ...
                            <label for="txt_buscar" id="lbBuscar">Buscar estado de clientes</label>
                        </div>
...
<div id="save-modal" class="modal" name="save-modal">
    <div class="modal-content">
                <h4 id="modal-title" class="center-align"></h4>
        <form method="POST" id="Estadoclientes" name="Estadoclientes" autocomplete="off" enctype="multipart/form-data" onsubmit="return Validar_Estado_Clientes();">
...
<?php
require_once('../../core/helpers/privado.php');
PaginaPrivado::footerPrivado('EstadoClientes');
?>